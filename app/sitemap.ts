...
import { getAllStateSlugs, getAllProcedureSlugs, getAllComparisonSlugs, getAllStateProcedurePairs } from '@/lib/db';
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [...staticPages, ...states, ...procedures, ...stateProcedures, ...comparisons];
}
